    ...
    for (let i = 0; i < storedItems.length; i++) {
        ...
        <div>
            ...
            <div class="info">
                ...
                <div class="myCartItem-price">$${myCartItem.price}</div>
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//async
// async function myDisplay(array) {
//     let myPromise = new Promise(function (resolve, reject) {
//         let myJSON = JSON.stringify(array);
//         // Save cart items to localStorage
//         localStorage.setItem("myCartItems", myJSON);
//         resolve(); // Resolve after saving to localStorage
//     });

//     await myPromise; // Wait for the promise to be resolved
//     // let storedItems = JSON.parse(localStorage.getItem("myCartItems"));
//     // console.log(storedItems); // Check the retrieved items
//     return JSON.parse(localStorage.getItem("myCartItems"));
// }

// addToCartBtns.forEach(addToCartBtn => {
//     addToCartBtn.addEventListener("click", () => {
//         myDisplay(shoppingCartArray);
//     })
// })
...
//     var image = element.firstChild.nextSibling;
//     var imageURL = image.src;
//     var name = element.firstChild.nextSibling.nextSibling.nextSibling.textContent;
//     var price = element.firstChild.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.textContent;
//     var category = element.firstChild.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.textContent;
